            ...
            if (state is SleepSessionInitial) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final sessionDuration = session.to.difference(session.from);
                  final formattedDuration = _formatDuration(sessionDuration);
                                ...
                                for (var breakItem in session.breaks)
                                  Padding(
                                    padding: const EdgeInsets.symmetric(
                                        vertical: 4.0),
                                    child: Text(
                                      'Break from ${_formatDateTime(breakItem.start)} to ${_formatDateTime(breakItem.end)} '
